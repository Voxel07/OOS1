...
int main(void)
{
	...
	f(1); // Ausgefuehrte Funktion: 2
	f(c); // Ausgefuehrte Funktion: 3
	f(i); // Ausgefuehrte Funktion: 2
	c = f('a'); // Ausgefuehrte Funktion: 3
	c = 'a';
	f(1, 2); // Ausgefuehrte Funktion: 5
